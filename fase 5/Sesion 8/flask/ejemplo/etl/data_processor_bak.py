...
class DataProcessor:
    ...
    def clear_characters(self, text: str) -> str:
        """Reemplaza caracteres acentuados por sus equivalentes sin acento"""
        if text is None or text == '':
            return ''
        
        # Diccionario de reemplazo de caracteres acentuados
        replacements = {
            'á': 'a',
            'é': 'e',
            'í': 'i',
    ...
    def transform_data(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Limpiar nombres
        df['nombre'] = df['nombre'].apply(self.clear_characters)
        df['apellido'] = df['apellido'].apply(self.clear_characters)
